...
echo "═══ tests ═══"
fail=0
for t in rls_isolation a0_token_hook ac7_price_recost b_recipe ac5_boq_import g_hardening m2_buildings_board ac8_feasibility ac1_offline_sync ac4_material_balance ac9_overrun ac11_expense_approval; do
  printf "  %-20s " "$t"
